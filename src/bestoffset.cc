...
void bestOffset(float ssd[NUM_BEST], int offsets[NUM_BEST], const double *left, const double *right, unsigned channels,
                unsigned ncorr, unsigned corr_len, const int initialOffset)
{
#if 0 // direct
